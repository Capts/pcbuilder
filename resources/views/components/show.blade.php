	...
	<div class="content-wrapper">
		...
		<section class="content-header">
		  ...
		  <ol class="breadcrumb">
		    ...
		    <li><a href="#"><i class="fa fa-microchip"></i>  {{ substr(strip_tags($com->component_name), 0, 15) }}{{ strlen(strip_tags($com->component_name)) > 15 ? '...' : "" }}</a></li>
		  </ol>
		</section>
			...
			<div class="row text-center" style="margin-top: 80px;">
				...
				<div class="col-md-2 col-md-offset-2 no-padding">
					...
					@if(!empty($com->component_image))
						<img src="{{asset('upload/component/image/' . $com->component_image)}}" class="img-thumbnail" style="height: 200px; width: auto;">
					@else
				...
				<div class="col-md-6 text-left visible-lg visible-md">
					...
					<p style="padding-bottom: 15px;font-size: 18px;font-weight: 0.1">
				...
				<div class="col-md-6 visible-xs visible-sm" style="border:2px solid red;">
					<br>
					<h4 class=""><b>{{ $com->component_name }}</b>
